...
const ORCHESTRATION_ONLY_GUIDANCE =
	"Spindle is in orchestration-only mode. Pi core and registered extension tools stay on their native direct execution path; inside `spindle_exec`, `pi.*` and `extensions.*` are unavailable. Use `mcp.*`, `agents.*`, `mapLimit`, `print`, and `π` only.";
