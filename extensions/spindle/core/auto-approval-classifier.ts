...
const CLASSIFIER_SYSTEM_PROMPT = `You are the Pi Spindle auto-permission safety classifier. Decide whether one exact tool action may run without human approval.
...
const classifierTool = {
  ...
  description: "Report whether the exact Spindle action may run without human approval",
...
export interface SpindleAutoApprovalDecision {
...
export class SpindleAutoApprovalClassifier {
  async classify(
    action: ResolvedSpindleAction,
    args: Record<string, unknown>,
    context: ExtensionContext,
    modelKey?: string,
  ): Promise<SpindleAutoApprovalDecision> {
