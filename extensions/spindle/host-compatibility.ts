...
const PI_HOST_PACKAGE_NAMES = new Set(["@earendil-works/pi-coding-agent", "@mariozechner/pi-coding-agent"]);
...
export const detectPiHostVersion = (cliPath: string | undefined = process.argv[1]): string | undefined => {
...
export const piHostCompatibilityWarning = (version: string | undefined = detectPiHostVersion()): string | undefined => {
	...
	return (
		...
		"; detected " +
		version +
		". Actor triggerTurn and other host continuations may be ignored. Upgrade Pi before relying on actor delivery."
	);
};
