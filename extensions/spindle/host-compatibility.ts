...
export const piHostCompatibilityWarning = (
  ...
  return "Pi Spindle requires Pi >= " + MINIMUM_PI_HOST_VERSION + "; detected " + version + ". Actor triggerTurn and other host continuations may be ignored. Upgrade Pi before relying on actor delivery.";
};
