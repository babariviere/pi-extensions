...
| `calldiff` | Call-stack diff panel after each agent run (TUI-only) + a `calldiff` tool for the agent |
...
| `night-mode` | Overnight `caffeinate` + Claude 5h budget guard with automated resume ([docs](extensions/night-mode/README.md)) |
